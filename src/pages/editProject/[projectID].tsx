        ...
        <div className="p-8">
          ...
          >
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.name?  <Input {...methods.register("name")} className="mr-4" defaultValue={project.name} /> :  <Input {...methods.register("name")} className="mr-4" />}
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.goal? <Textarea {...methods.register("goal")} className="mr-4" defaultValue={project.goal}/> : <Textarea {...methods.register("goal")} className="mr-4"/>}
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.expectedMovement? <Textarea {...methods.register("expectedMovement")} className="mr-4" defaultValue={project.expectedMovement}/> : <Textarea {...methods.register("expectedMovement")} className="mr-4"/>}
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              {project.estimatedEnd? 
                <Input {...methods.register("estimatedEnd")} type="date" className="mr-4"
                  defaultValue={project.estimatedEnd.toISOString().slice(0, 10)}
                /> :
                <Input {...methods.register("estimatedEnd")} type="date" className="mr-4"
                />// may need to insert blank string here?
              }
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.trigger?  <Textarea {...methods.register("trigger")} className="mr-4" defaultValue={project.trigger} /> :  <Textarea {...methods.register("trigger")} className="mr-4"/>}
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.alternativeOptions? <Textarea {...methods.register("alternativeOptions")} className="mr-4" defaultValue={project.alternativeOptions} /> : <Textarea {...methods.register("alternativeOptions")} className="mr-4"/>}
                <InfoIcon content="" />
              </div>
            ...
            <div className="grid w-full max-w-md items-center gap-1.5">
              ...
              <div className="flex items-center">
                {project.estimatedRisk? <Textarea {...methods.register("estimatedRisk")} className="mr-4" defaultValue={project.estimatedRisk} />: <Textarea {...methods.register("estimatedRisk")} className="mr-4" />}
                <InfoIcon content="" />
              </div>
