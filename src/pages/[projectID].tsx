    ...
    <>
      {isMemberFound ? (
        <div className="p-8">
          ...
          {!isReadMoreShown ? (
            ...
            <>
              ...
              <div className="flex flex-row">
                ...
                <p className="ml-1">
                  {project.trigger === "" ? "N/A" : project.trigger}
                </p>
              </div>
              <div className="flex flex-row">
                <Label className="font-medium">Expected Outcome:</Label>
                <p className="ml-1">
                  {project.expectedMovement === ""
                    ? "N/A"
                    : project.expectedMovement}
                </p>
              </div>
              ...
              <div className="flex flex-row">
                ...
                <p className="ml-1">
                  {project.estimatedRisk === "" ? "N/A" : project.estimatedRisk}
                </p>
              </div>
              <div className="flex flex-row">
                <Label className="font-medium">
          ...
          >
            {" "}
            {!isReadMoreShown ? "See More..." : "See Less..."}
          </Button>
            ...
            >
              <Button variant={"default"}>
                {project.status === "Complete"
                  ? "View Project Completion Details"
                  : "Complete Project"}
              </Button>
            </Link>
          ...
          <Link
            href={"/newActivity/" + id}
            className={
              project.status == "Complete" ? "pointer-events-none" : ""
            }
            onClick={() => setLoading(true)}
          >
            <Button
              type="submit"
              variant={project?.status == "Active" ? "default" : "subtle"}
              className={
                project.status == "Active" ? "mt-5 bg-green-500" : "mt-5"
              }
            >
              Add New Activity
            </Button>
          ...
          <h2 className="mt-10 mb-5 text-2xl font-bold">
            Value Created for this Project
          </h2>
          <div>
            <p>TO BE COMPLETED</p>
          </div>
